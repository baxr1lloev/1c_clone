...
export function ColumnCustomization({
    ...
    useEffect(() => {
        localStorage.setItem(`column_visibility_${tableName}`, JSON.stringify(columnVisibility));
    ...
    const visibleCount = Object.values(columnVisibility).filter(v => v !== false).length;
