  ...
  const entries: LedgerEntry[] = accountId
    ? [
        ...
        },
        {
          ...
          documentNumber: 'SL-2024-0001',
          documentId: 1,
          documentRefType: 'sales-document',
        ...
        },
        {
          ...
          documentNumber: 'PAY-2024-0001',
          documentId: 1,
          documentRefType: 'payment-document',
        ...
        },
        {
          ...
          documentId: 1,
          documentRefType: 'purchase-document',
          ...
          <div className="flex flex-col items-center justify-center h-full text-muted-foreground opacity-50">
            ...
            <p>
              {accountId
                ...
                : 'Select an account from Trial Balance to view details.'}
            </p>
          </div>
        )}
      </div>
