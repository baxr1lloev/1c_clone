...
const demoEntries: JournalEntry[] = [
  { id: 1, tenant: 1, number: 'JE-2024-0001', date: '2024-01-20', description: 'Sales Document SL-2024-0001', document_type: 'sale', document_id: 1, total_debit: 1650, total_credit: 1650, lines: [], is_posted: true, created_by: 1, created_at: '2024-01-20', updated_at: '2024-01-20' },
  { id: 2, tenant: 1, number: 'JE-2024-0002', date: '2024-01-20', description: 'Payment received for SL-2024-0001', document_type: 'payment', document_id: 1, total_debit: 1650, total_credit: 1650, lines: [], is_posted: true, created_by: 1, created_at: '2024-01-20', updated_at: '2024-01-20' },
  { id: 3, tenant: 1, number: 'JE-2024-0003', date: '2024-01-18', description: 'Purchase Document PR-2024-0001', document_type: 'purchase', document_id: 1, total_debit: 5500, total_credit: 5500, lines: [], is_posted: true, created_by: 1, created_at: '2024-01-18', updated_at: '2024-01-18' },
  { id: 4, tenant: 1, number: 'JE-2024-0004', date: '2024-01-21', description: 'Payment made for PR-2024-0001', document_type: 'payment', document_id: 2, total_debit: 5500, total_credit: 5500, lines: [], is_posted: true, created_by: 1, created_at: '2024-01-21', updated_at: '2024-01-21' },
];
...
export default function JournalEntriesPage() {
  ...
  const { data, isLoading, refetch } = useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        const response = await api.get<PaginatedResponse<JournalEntry>>(`/accounting/journal-entries/?${params.toString()}`);
  ...
  return (
    <div className="space-y-6">
      ...
      <DataTable columns={columns} data={data || []} isLoading={isLoading} searchColumn="number" searchPlaceholder="Search journal entries..." onRefresh={() => refetch()} onExport={() => { }} />
    </div>
  );
}
