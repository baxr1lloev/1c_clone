...
export default function DashboardPage() {
  ...
  const quickActions = [
    {
      label: t("quickActionsCreateSale"),
      href: "/documents/sales/new",
      icon: PiFileTextBold,
    },
    {
      label: t("quickActionsCreatePurchase"),
      href: "/documents/purchases/new",
      icon: PiPackageBold,
    },
    {
      label: t("quickActionsAddCounterparty"),
      href: "/directories/counterparties/new",
      icon: PiUsersBold,
    },
    {
      label: t("quickActionsAddProduct"),
      href: "/directories/items/new",
      icon: PiPackageBold,
    },
  ];
              ...
              <CardContent>
                {isLoading ? (
                  ...
                  <>
                    ...
                    <div
                      className={`flex items-center text-xs mt-1 ${stat.trendUp ? "text-emerald-600" : "text-rose-600"}`}
                    >
                      {stat.trendUp ? (
